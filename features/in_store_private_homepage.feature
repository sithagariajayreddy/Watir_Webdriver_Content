...
#    Then I should see the modal title xxx's Furniture PowerCharge® Card Important Disclosures
...
#    Error Messages
  ...
  Scenario: In store private Verify the error messages
    ...
    And I see xxxx in store private consolidate error messages in the end of the page
